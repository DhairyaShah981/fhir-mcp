...
| De-id leakage          | 1/1 ✅ (3 bundles · 0 leaks) | 2026-05-23  |
| Code validation        | 31/31 ✅ (LOINC · SNOMED · RxNorm · ICD-10) | 2026-05-23  |
| CDS Hooks correctness  | 4/4 ✅         | 2026-05-23  |

**Engineering health:** 169 tests passing · **96% line coverage** · ruff + pyright clean · MCP stdio end-to-end verified.
...
- **v0.1** (shipped 2026-05-23): all 8 tools, 3 resources, 3 prompts, full eval suite (4 categories), 169 tests at 96% coverage, MCP stdio verified end-to-end.
- **v0.2** (Q3 2026): PyPI publish; SMART on FHIR OAuth2 against SMART Health IT + Epic on FHIR sandboxes; Supabase cloud mode (audit + vault); Langfuse-enabled span linking demo; cross-model eval bench (Claude vs GPT vs Gemini judges).
- **v0.3** (Q4 2026): bulk export (`$export`), FHIR Subscriptions, R5 dual support, threat model + STRIDE doc.
